...
class _MatchHistoryScreenState extends State<MatchHistoryScreen> {
            ...
            actions: isSwapping
                ...
                : [
                    IconButton(
                        ...
                        onPressed:
                            session == null ? null : () => _showClear(context)),
  ...
  Widget _buildContent(Session session) =>
      LayoutBuilder(builder: (context, constraints) {
        double scale = (constraints.maxWidth / 900.0).clamp(1.1, 1.8);
        if (session.games.length >= 4 || constraints.maxHeight < 700)
          scale *= 0.85;
  ...
  Widget _buildFABs(Session? session) =>
      Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        FloatingActionButton.extended(
          heroTag: 'add',
          onPressed:
              widget.notifier.isGenerating ? null : () => _showSettings(false),
  ...
  void _showClear(BuildContext context) => showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
            ...
            actions: [
              ...
              TextButton(
                  ...
                  child:
                      const Text('クリア', style: TextStyle(color: Colors.red))),
            ],
          ));
}
